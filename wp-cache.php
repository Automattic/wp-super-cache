...
// Load dependencies.
function wpsc_load_dependencies() {

	if ( !function_exists( 'wp_cache_debug' ) ) {
		include_once( dirname( __FILE__ ) .'/wp-cache-phase1.php' );
	}

	if ( !function_exists( 'prune_super_cache' ) ) {
		include_once( dirname( __FILE__ ) .'/wp-cache-phase2.php' );
	}
}
