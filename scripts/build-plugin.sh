...
#
# This is a pure build step: it packages whatever is currently checked out and
# makes no assumptions about branch or git state. It runs both locally
# (`make build`) and in CI as part of the release workflow, so it must stay
# non-interactive.
