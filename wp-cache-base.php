...
$blogcacheid = '';
if ( ( defined( 'WP_ALLOW_MULTISITE' ) && true == constant( 'WP_ALLOW_MULTISITE' ) ) || defined( 'SUBDOMAIN_INSTALL' ) || defined( 'VHOST' ) || defined( 'SUNRISE' ) ) {
    $blogcacheid = 'blog'; // main blog
    if ( defined( 'SUBDOMAIN_INSTALL' ) && true == constant( 'SUBDOMAIN_INSTALL' ) ) {
