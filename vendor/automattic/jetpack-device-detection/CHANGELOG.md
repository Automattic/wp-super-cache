...
### Fixed
- Ensure that User_Agent is loaded in environments without autoload enabled. (e.g.: WordPress.com and Super Cache)
...
[1.4.20-alpha]: https://github.com/Automattic/jetpack-device-detection/compare/v1.4.19...v1.4.20-alpha
